#!/usr/bin/env python3
"""Generate PDF and Markdown from JSON media lists."""
...
PDF_TITLES = {
    'media_list.json':       'Media Mentions of Oliver Gutsche',
    'short_media_list.json': 'Selected Media Mentions of Oliver Gutsche',
}
...
def build_pdf(records, output_file, pdf_title):
    ...
    for i, record in enumerate(records, 1):
        ...
        author = xml_escape(meta.get('author', ''))
        ...
        story.append(Paragraph(f'{byline}{date_str} \u2014 {note_html}', meta_style))
...
def build_md(records, output_file):
    ...
    for i, record in enumerate(records, 1):
        ...
        lines.append(f'   {byline}{date_str} \u2014 {note_md}')
        lines.append('')
...
def main():
    ...
    pdf_title = PDF_TITLES.get(input_path.name, 'Media Mentions of Oliver Gutsche')
