...
\usepackage{calc} % required by pandoc 3.x for table column width arithmetic (\real{})
...
% Modern section styling with accent color
\usepackage{titlesec}
\titleformat{\section}
...
% Route physics math symbols through math mode so they render regardless of body font
